...
SEARCH_KEYWORD_TYPES = {
    ...
    "키워드": support_organizations_keywords
    + associations_keywords
    + institutions_keywords,
    # "키워드": 부동산_키워드,
    # "키워드": 센터 + 마케팅 + 기관,
...
# SMTP 서버 설정
# EMAIL_SMTP_SERVER = os.getenv("EMAIL_SMTP_SERVER", "smtp.daum.net")
# EMAIL_SMTP_PORT = os.getenv("EMAIL_SMTP_PORT", 465)  # TLS 사용 시 587, SSL 사용 시 465
...
# 다음
EMAIL_SMTP_SERVER = "smtp.daum.net"
EMAIL_SMTP_PORT = 465  # TLS 사용 시 587, SSL 사용 시 465
...
# 이메일 제목
EMAIL_SUBJECT = "(광고) 위븐 CMO 김명구 드림: 모두 홈페이지 무료 이전 (금일 마감)"
...
NAVER_API_CALL_DELAY = 2  # API 호출 간 딜레이 (초)
